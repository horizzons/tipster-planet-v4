    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="text-gray-400 hover:text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-full hover:bg-opacity-100 focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0"
        >
